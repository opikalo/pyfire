   ...
   public class ZPP_Polygon extends ZPP_Shape
   {
         ...
         if(zip_gaxi)
         {
            if(body != null)
            {
               ...
               while(_loc3_ != null)
               {
                  ...
                  _loc6_.gp0 = _loc4_;
                  _loc6_.gp1 = _loc5_;
                  _loc6_.gnormx = body.axisy * _loc6_.lnormx - body.axisx * _loc6_.lnormy;
                  _loc6_.gnormy = _loc6_.lnormx * body.axisx + _loc6_.lnormy * body.axisy;
                  _loc6_.gprojection = (body.posx * _loc6_.gnormx + body.posy * _loc6_.gnormy) + _loc6_.lprojection;
                  if(_loc6_.wrap_gnorm != null)
                  {
                     _loc6_.wrap_gnorm.zpp_inner.x = _loc6_.gnormx;
                     _loc6_.wrap_gnorm.zpp_inner.y = _loc6_.gnormy;
                  }
                  _loc6_.tp0 = _loc6_.gp0.y * _loc6_.gnormx - _loc6_.gp0.x * _loc6_.gnormy;
                  _loc6_.tp1 = _loc6_.gp1.y * _loc6_.gnormx - _loc6_.gp1.x * _loc6_.gnormy;
                  _loc4_ = _loc5_;
                  _loc3_ = _loc3_.next;
               }
               _loc5_ = gverts.next;
      ...
      public function valid() : ValidationResult
      {
         ...
         if(zip_valid)
         {
            ...
            while(_loc4_ != null)
            {
               ...
               if((_loc7_ * _loc7_ + _loc8_ * _loc8_) < 1.0E-8)
               {
                  _loc2_ = false;
                  _loc3_ = false;
                  break;
      ...
      public function localCOM_invalidate(param1:ZPP_Vec2) : void
      {
         ...
         while(_loc4_ != null)
         {
            _loc5_ = _loc4_;
            _loc10_ = 1.0;
            _loc5_.x = _loc5_.x + _loc3_ * _loc10_;
            _loc5_.y = _loc5_.y + _loc8_ * _loc10_;
            _loc4_ = _loc4_.next;
         }
         invalidate_lverts();
      }
      ...
      public function __validate_area_inertia() : void
      {
         ...
         else
         {
            ...
            while(_loc3_ != null)
            {
               ...
               _loc1_ = _loc1_ + _loc7_ * _loc8_;
               _loc2_ = _loc2_ + _loc7_;
               area = area + _loc5_.x * (_loc6_.y - _loc4_.y);
               _loc4_ = _loc5_;
               _loc5_ = _loc6_;
               _loc3_ = _loc3_.next;
            }
            ...
            _loc1_ = _loc1_ + _loc7_ * _loc8_;
            _loc2_ = _loc2_ + _loc7_;
            area = area + _loc5_.x * (_loc9_.y - _loc4_.y);
      ...
      public function __validate_angDrag() : void
      {
         ...
         while(_loc7_ != null)
         {
            ...
            _loc9_ = _loc2_.elt;
            _loc2_ = _loc2_.next;
            _loc3_ = _loc3_ + _loc9_.length;
            _loc10_ = _loc8_.x - _loc6_.x;
            _loc11_ = _loc8_.y - _loc6_.y;
            _loc1_ = _loc1_ + _loc9_.length * 2.5 * material.dynamicFriction * _loc9_.lprojection * _loc9_.lprojection;
            ...
            if(_loc12_ > 0)
            {
               ...
               _loc15_ = _loc6_.y;
               _loc16_ = _loc13_;
               _loc14_ = _loc14_ + _loc10_ * _loc16_;
               _loc15_ = _loc15_ + _loc11_ * _loc16_;
               ...
               _loc1_ = _loc1_ + _loc18_ * _loc13_ * _loc9_.length * 100;
            }
            if(_loc12_ > 0)
            {
               if(_loc12_ < 1)
               {
                  ...
                  _loc18_ = (_loc17_ * _loc17_ * _loc17_ - _loc16_ * _loc16_ * _loc16_) / (3 * (_loc17_ - _loc16_));
                  _loc1_ = _loc1_ + _loc18_ * 0.5 * (1 - _loc13_) * _loc9_.length * 100;
               }
               if(_loc12_ < 1)
               {
                  _loc5_ = _loc7_;
      ...
      public function __translate(param1:Number, param2:Number) : void
      {
         ...
         while(_loc3_ != null)
         {
            _loc4_ = _loc3_;
            _loc5_ = 1.0;
            _loc4_.x = _loc4_.x + param1 * _loc5_;
            _loc4_.y = _loc4_.y + param2 * _loc5_;
            _loc3_ = _loc3_.next;
         }
         invalidate_lverts();
      }
      ...
      public function __copy() : ZPP_Polygon
      {
         ...
         var _loc1_:ZPP_Polygon = new Polygon(_loc2_.zpp_inner_zn.wrap_lverts).zpp_inner_zn;
         return _loc1_;
      }
