package com.bit101.components
{
   ...
   public class List extends Component
   {
      ...
      protected function makeListItems() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            _loc3_ = new this._listItemClass(this._itemHolder,0,_loc2_ * this._listItemHeight);
            _loc3_.setSize(width,this._listItemHeight);
            _loc3_.defaultColor = this._defaultColor;
            _loc3_.selectedColor = this._selectedColor;
            _loc3_.rolloverColor = this._rolloverColor;
