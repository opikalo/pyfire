package com.junkbyte.console.core
{
   ...
   public class Executer extends EventDispatcher
   {
      ...
      private function execNest(param1:String) : *
      {
         ...
         var param1:String = this.ignoreWhite(param1);
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(param1.substring(_loc2_ + 1,_loc3_).search(new RegExp("\\w")) >= 0)
            {
               ...
               while(true)
               {
                  ...
                  if((_loc9_.match(new RegExp("[^\\s]"))) || _loc8_ <= 0)
                  {
                     break;
                  }
                  _loc8_--;
      ...
      {
         var param1:String = param1.substring(0,param3) + VALKEY + this._values.length + param1.substring(param4);
